<script>
        ...
        <script>
            //hash
            var hshInp = document.getElementById('hshInpText');
            var hshInpType = document.getElementById('hshInpType');
            var hashVariant = document.getElementById('hashVariant');
            var hashRounds = document.getElementById('hashRounds');
            var hshOutType = document.getElementById('hshOutType');
            var hshOut = document.getElementById('hshOutText');
            ...
            function calcHash() {
                try {
                    var hashObj = new jsSHA(
                        ...
                        hshInpType.options[hshInpType.selectedIndex].value, {
                            numRounds: parseInt(hashRounds.value, 10)
                        }
                    );
                    hashObj.update(hshInp.value);
                    hshOut.value = hashObj.getHash(hshOutType.options[hshOutType.selectedIndex].value);
                } catch (e) {
                    hshOut.value = e.message
                }
            }
            ...
            window.setTimeout(() => {
                if (typeof clickSelCnt == 'function') clickSelCnt('pre.code')
            }, 4000);
        </script>